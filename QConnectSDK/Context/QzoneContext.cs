...
namespace QConnectSDK.Context
{
    ...
    public class QzoneContext
    {
        ...
        public QzoneContext(OAuthToken oAuthToken, string appkey)
        {
            this.oAuthToken = oAuthToken;
            this.config = new QQConnectConfig { AppKey = appkey };
            this.restApi = new RestApi(this);   
        }
        ...
        {
            oAuthToken.OpenId = restApi.GetOpenId(oAuthToken.AccessToken);
        }
    }
}
